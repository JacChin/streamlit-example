...
# You can add more features based on your DataFrame columns
...
heartDiseaseorAttack = st.sidebar.slider('HeartDiseaseorAttack', min(df['HeartDiseaseorAttack']), max(df['HeartDiseaseorAttack']), df['HeartDiseaseorAttack'].mean())
physActivity = st.sidebar.slider('PhysActivity', min(df['PhysActivity']), max(df['PhysActivity']), df['PhysActivity'].mean())
...
hvyAlcoholConsump = st.sidebar.slider('HvyAlcoholConsump', min(df['HvyAlcoholConsump']), max(df['HvyAlcoholConsump']), df['HvyAlcoholConsump'].mean())
anyHealthcare = st.sidebar.slider('AnyHealthcare', min(df['AnyHealthcare']), max(df['AnyHealthcare']), df['AnyHealthcare'].mean())
